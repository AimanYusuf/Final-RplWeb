    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/wp-admin" class="font-bold text-xl text-dark block px-4">REB<span
                        ...
                        <ul class="py-1" role="none">
                            ...
                            <li>
                                <form action="/logout" method="post">
                                    @csrf
                                    <button type="submit"
                                        class="block w-full text-start px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Log
                                        out</button>
                                </form>
                            </li>
                        </ul>
