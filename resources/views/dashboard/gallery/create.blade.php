                ...
                <form action="/dashboard/gallery" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        <label for="message" class="block mb-2 text-sm font-medium text-gray-900 ">Your
                            Caption</label>
                        <textarea id="message" rows="4" value="{{ old('caption') }}" name="caption"
                            class="block p-2.5 w-full text-sm md:w-1/2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
